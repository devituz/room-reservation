...
var FullCalendar = function (e) {
    ...
    function y(e, t, n) {
        ...
        if (arguments.length > 2 && (s.children = arguments.length > 3 ? i.call(arguments, 2) : n), "function" == typeof e && null != e.defaultProps) for (a in e.defaultProps) void 0 === s[a] && (s[a] = e.defaultProps[a]);
    ...
    function w(e, t, n, r, o) {
        ...
        } else if ("o" === t[0] && "n" === t[1]) i = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + i] = n, n ? r || e.addEventListener(t, i ? T : D, i) : e.removeEventListener(t, i ? T : D, i); else if ("dangerouslySetInnerHTML" !== t) {
            if (o) t = t.replace(/xlink(H|:h)/, "h").replace(/sName$/, "s"); else if ("width" !== t && "height" !== t && "href" !== t && "list" !== t && "form" !== t && "tabIndex" !== t && "download" !== t && t in e) try {
                e[t] = null == n ? "" : n;
                break e
            } catch (e) {
            }
    ...
    function I(e, t, n, r, o, i, a, s, l, u) {
        var c, d, p, v, g, m, y, S = r && r.__k || h, w = S.length;
        for (n.__k = [], c = 0; c < t.length; c++) if (null != (v = n.__k[c] = null == (v = t[c]) || "boolean" == typeof v ? null : "string" == typeof v || "number" == typeof v || "bigint" == typeof v ? E(null, v, null, null, v) : Array.isArray(v) ? E(b, {children: v}, null, null, null) : v.__b > 0 ? E(v.type, v.props, v.key, v.ref ? v.ref : null, v.__v) : v)) {
            if (v.__ = n, v.__b = n.__b + 1, null === (p = S[c]) || p && v.key == p.key && v.type === p.type) S[c] = void 0; else for (d = 0; d < w; d++) {
    ...
    function A(e) {
        ...
        if (e.__k) for (t = e.__k.length - 1; t >= 0; t--) if ((n = e.__k[t]) && (r = A(n))) return r;
        return null
    }
    ...
    function U(e, t, n, r, o, a, s, l) {
        ...
        if ("svg" === v && (o = !0), null != a) for (; g < a.length; g++) if ((u = a[g]) && "setAttribute" in u == !!v && (v ? u.localName === v : 3 === u.nodeType)) {
            e = u, a[g] = null;
            break
        }
        if (null == e) {
        ...
        if (null === v) p === h || l && e.data === h || (e.data = h); else {
            ...
            }(e, h, p, o, l), d) t.__k = []; else if (g = t.props.children, I(e, Array.isArray(g) ? g : [g], t, n, r, o && "foreignObject" !== v, a, s, a ? a[0] : n.__k && C(n, 0), l), null != a) for (g = a.length; g--;) null != a[g] && m(a[g]);
    ...
    function V(e, t, n) {
        ...
        if (r = e.__k) for (o = 0; o < r.length; o++) r[o] && V(r[o], t, n || "function" != typeof e.type);
    ...
    var B, j, G, q = [], Y = [], Z = a.__b, X = a.__r, K = a.diffed, $ = a.__c, J = a.unmount;

    function Q() {
        for (var e; e = q.shift();) if (e.__P && e.__H) try {
    ...
    function ge(e) {
        ...
        }), F(y(ve, {context: t.context}, e.__v), t.l)) : t.l && t.componentWillUnmount()
    }

    (fe.prototype = new x).__a = function (e) {
        var t = this, n = pe(t.__v), r = t.o.get(e);
    ...
    var me = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103,
        ...
        Ee = "undefined" != typeof document, be = function (e) {
    ...
    _e.FullCalendarVDom ? console.warn("FullCalendar VDOM already loaded") : _e.FullCalendarVDom = {
        Component: x, createElement: y, render: F, createRef: function () {
            return {current: null}
        }, Fragment: b, createContext: function (e) {
            var t = function (e, t) {
                var n = {
    ...
    function St(e, t, n, r) {
        var o = Ct([t, 0, 1 + wt(t, n, r)]), i = bt(e), a = Math.round(gt(o, i));
        ...
        for (var l in s = Pt(s, (function (e) {
            ...
            if (u.recurringDef) {
                ...
                for (var d = 0, p = Ft(u, c, t, r, o.recurringTypes); d < p.length; d++) {
                    var f = p[d], h = Rt(l, {start: f, end: r.add(f, c)});
                    s[h.instanceId] = h
                }
            }
        }
    ...
    var sn = {week: 3, separator: 0, omitZeroMinute: 0, meridiem: 0, omitCommas: 0},
        ...
        un = /\s*([ap])\.?m\.?/i, cn = /,/g, dn = /\s+/g, pn = /\u200e/g, fn = /UTC|GMT/, hn = function () {
            function e(e) {
                var t = {}, n = {}, r = 0;
    ...
    var Sn = {
            ...
            _resize: Mn,
            _scrollRequest: Mn
        }, Tn = {buttonText: Mn, buttonHints: Mn, views: Mn, plugins: Mn, initialEvents: Mn, events: Mn, eventSources: Mn},
        xn = {
            headerToolbar: Cn,
            footerToolbar: Cn,
            buttonText: Cn,
    ...
    function Nn(e, t) {
        var n = e.instances[t];
        if (n) {
            var r = e.defs[n.defId], o = On(e, (function (e) {
    ...
    function On(e, t) {
        var n = Pt(e.defs, t), r = Pt(e.instances, (function (e) {
            return n[e.defId]
        }));
    ...
    var Bn = {id: String, groupId: String, title: String, url: String, interactive: Boolean},
        jn = {start: Mn, end: Mn, date: Mn, allDay: Boolean}, Gn = r(r(r({}, Bn), jn), {extendedProps: Mn});

    function qn(e, t, n, r, o) {
        void 0 === o && (o = Zn(n));
        var i = Yn(e, n, o), a = i.refined, s = i.extra, l = function (e, t) {
            var n = null;
            e && (n = e.defaultAllDay);
        ...
        var c, d = function (e, t, n, r) {
            ...
            if (o = n.dateEnv.createMarkerMeta(c), o) s = o.marker; else if (!r) return null;
    ...
    function Kn(e) {
        var t = Math.floor(gt(e.start, e.end)) || 1, n = bt(e.start);
    ...
    function $n(e, t) {
        ...
        return e.start && (n = bt(e.start), r && r <= n && (r = ft(n, 1))), {start: n, end: r}
    }
    ...
    function sr(e, t, n, r) {
        ...
        for (var d in e.instances) {
            var p = e.instances[d], f = u[(b = e.defs[p.defId]).defId], h = p.range, v = !b.allDay && r ? $n(h, r) : h,
                g = nr(v, n);
        ...
        for (var m in o) for (var y = 0, E = er(o[m], n); y < E.length; y++) {
            var b, S = E[y];
            f = u[(b = a[m]).defId];
            s.push({def: b, ui: f, instance: null, range: S, isStart: !1, isEnd: !1})
        }
        for (var c in i) for (var w = 0, D = er(i[c], n); w < D.length; w++) {
            S = D[w];
    ...
    function yr(e, t, n, r, o, i, a) {
        ...
        var f = p.range.start, h = p.range.end, v = i || e.start || e.eventRange.range.start,
            g = a || e.end || e.eventRange.range.end, m = bt(f).valueOf() === bt(v).valueOf(),
    ...
    function Er(e, t, n) {
        ...
        return {isPast: r.end < (n || t.start), isFuture: r.start >= (n || t.end), isToday: t && ar(t, r.start)}
    }
    ...
    function wr(e, t) {
        ...
        return null == s && null == (s = r.interactive) && (s = Boolean(a.hasHandlers("eventClick"))), s ? Ye((function (e) {
            a.trigger("eventClick", {el: e.target, event: new Vr(t, r, o), jsEvent: e, view: t.viewApi})
        })) : {}
    }
    ...
    function Tr(e, t, n) {
        var o = function (e, t) {
            var n = Rn(e, Dr), o = n.refined, i = n.extra, a = o.start ? t.createMarkerMeta(o.start) : null,
    ...
    function Rr(e, t) {
        ...
        return r(i, (n = e, o = t.dateEnv, r(r({}, kr(n.range, o, n.allDay)), {allDay: n.allDay}))), i
    }
    ...
    function Ir(e, t, n, r) {
        var o = dr(e.defs, t), i = {defs: {}, instances: {}};
        for (var a in e.defs) {
            var s = e.defs[a];
    ...
    function Or(e, t, n) {
        var r;
        if (void 0 === n && (n = Lr(t)), "string" == typeof e ? r = {url: e} : "function" == typeof e || Array.isArray(e) ? r = {events: e} : "object" == typeof e && e && (r = e), r) {
            var o = Rn(r, n), i = o.refined, a = o.extra, s = function (e, t) {
    ...
    var Wr = function () {
        ...
        return e.prototype.getCurrentData = function () {
            ...
            var t = this.getCurrentData(), n = Gt(e);
            ...
            var r = this.getCurrentData(), o = Tr(n, r.dateEnv, Gt({days: 1}));
            o && (this.dispatch({type: "SELECT_DATES", selection: o}), _r(o, null, r))
            ...
            if (t instanceof Me) o = t.internalEventSource; else if ("boolean" == typeof t) t && (o = At(i.eventSources)[0]); else if (null != t) {
            ...
            if (s) {
                ...
                return this.dispatch({type: "ADD_EVENTS", eventStore: Pn(s)}), this.triggerEventAdd(l), l
            }
            return null
            ...
            for (var r in e = String(e), n) if (n[r].publicId === e) return new Me(t, n[r]);
            return null
            ...
            var n = Or(e, t);
            return n ? (this.dispatch({type: "ADD_EVENT_SOURCES", sources: [n]}), new Me(t, n)) : null
        ...
        return e.prototype.setProp = function (e, t) {
            var n, r;
            if (e in jn) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead."); else if ("id" === e) t = Bn[e](t), this.mutate({standardProps: {publicId: t}}); else if (e in Bn) t = Bn[e](t), this.mutate({standardProps: (n = {}, n[e] = t, n)}); else if (e in Un) {
                var o = Un[e](t);
            ...
            var t = this._context.dateEnv, n = this._instance, r = bn(e);
            ...
            if (n) {
                var r = this._def, o = this._context, i = o.getCurrentData().eventStore, a = Nn(i, n.instanceId);
                a = Ir(a, {
                    "": {
                        display: "",
                        startEditable: !0,
    ...
    var Zr = function () {
        ...
        return e.prototype.createMarker = function (e) {
            ...
            return null !== n ? {unit: "year", value: n} : null !== (n = this.diffWholeMonths(e, t)) ? {
                unit: "month",
                value: n
            } : null !== (n = yt(e, t)) ? {unit: "week", value: n} : null !== (n = Et(e, t)) ? {
                unit: "day",
                value: n
            } : (n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 36e5
            }(e, t), ut(n) ? {unit: "hour", value: n} : (n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 6e4
            }(e, t), ut(n) ? {unit: "minute", value: n} : (n = function (e, t) {
                return (t.valueOf() - e.valueOf()) / 1e3
            }(e, t), ut(n) ? {unit: "second", value: n} : {unit: "millisecond", value: t.valueOf() - e.valueOf()})))
            ...
            return this.weekNumberFunc ? this.weekNumberFunc(this.toDate(e)) : function (e, t, n) {
                var r = e.getUTCFullYear(), o = St(e, r, t, n);
    ...
    function Jr(e) {
        for (var t = e.length > 0 ? e[0].code : "en", n = Xr.concat(e), r = {en: $r}, o = 0, i = n; o < i.length; o++) {
            var a = i[o];
            r[a.code] = a
        }
    ...
    function to(e) {
        ...
        return new Zr(r(r({timeZone: wn.timeZone, calendarSystem: "gregory"}, e), {locale: t}))
    }
    ...
    var po = {defs: {}, instances: {}}, fo = function () {
        function e() {
        ...
        return e.prototype.splitProps = function (e) {
            ...
            for (var c in this.eventUiBuilders = Nt(n, (function (e, n) {
                ...
                var d = n[c], p = a[c] || po, f = this.eventUiBuilders[c];
                u[c] = {
            ...
            if (e) {
                var n = this._splitEventStore(e.affectedEvents, this._getKeysForEventDefs(e.affectedEvents)),
                    ...
                    i = function (r) {
                        t[r] || (t[r] = {affectedEvents: n[r] || po, mutatedEvents: o[r] || po, isEvent: e.isEvent})
                    };
                for (var a in n) i(a);
                for (var a in o) i(a)
            }
    ...
    var mo = bn({year: "numeric", month: "long", day: "numeric"}), yo = bn({week: "long"});

    function Eo(e, t, n, o) {
        void 0 === n && (n = "day"), void 0 === o && (o = !0);
        var i = e.dateEnv, a = e.options, s = e.calendarApi, l = i.format(t, "week" === n ? yo : mo);
        if (a.navLinks) {
            ...
            return r({title: st(a.navLinkHint, [l, u], l), "data-navlink": ""}, o ? qe(c) : {onClick: c})
        }
        return {"aria-label": l}
    }
    ...
    function xo(e, t) {
        ...
        var n = window.getComputedStyle(e), r = parseInt(n.borderLeftWidth, 10) || 0,
            ...
            a = parseInt(n.borderBottomWidth, 10) || 0, s = To(e), l = s.y - r - o, u = {
                borderLeft: r,
                borderRight: o,
                borderTop: i,
                borderBottom: a,
    ...
    function Co(e, t, n) {
        void 0 === t && (t = !1);
        var r = n ? e.getBoundingClientRect() : ko(e), o = xo(e, t), i = {
    ...
    var Oo = FullCalendarVDom.Component, Lo = FullCalendarVDom.createElement, Uo = FullCalendarVDom.render,
        Wo = FullCalendarVDom.createRef, Vo = FullCalendarVDom.Fragment, zo = FullCalendarVDom.createContext,
        Fo = FullCalendarVDom.createPortal, Bo = FullCalendarVDom.flushSync,
        jo = FullCalendarVDom.unmountComponentAtNode, Go = function () {
            function e(e, t, n, o) {
                var i = this;
    ...
    var si = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var e = this.props, t = di(e.content, e.hookProps);
            ...
            return Lo(qo.Consumer, null, (function (n) {
                return Lo(pi, {viewSpec: n.viewSpec}, (function (o, i) {
                    ...
                    return Lo(oi, {
                        ...
                        return Lo("div", {className: i.concat(t).join(" "), ref: e}, r)
                    }))
                }))
            }))
    ...
    function vi(e, t, n, o) {
        var i = fi(e), a = fi(t.views), s = function (e, t) {
            var n, r = {};
    ...
    var mi = function () {
        ...
        return e.prototype.buildPrev = function (e, t, n) {
            ...
            return n || ((t = this.props.dateAlignment) ? Gt(1, t) : e || Gt({days: 1}))
    ...
    function yi(e, t, n) {
        ...
        return Si({}, function (e, t) {
            var n = Lr(t), r = [].concat(e.eventSources || []), o = [];
    ...
    function Ti(e, t, n, o) {
        var i = o.options, a = o.calendarApi, s = o.pluginHooks.eventSourceDefs[e.sourceDefId], l = Xe();
    ...
    var Vi = [ei({
        ...
        recurringTypes: [{
            parse: function (e, t) {
                ...
                return r ? function (e, t, n, r) {
                    var o = e ? Ht(e) : null, i = bt(n.start), a = n.end, s = [];
                    for (; i < a;) {
                        var l = void 0;
        ...
        }], eventRefiners: {daysOfWeek: Mn, startTime: Gt, endTime: Gt, duration: Gt, startRecur: Mn, endRecur: Mn}
    }), ei({
        optionChangeHandlers: {
            events: function (e, t) {
                Wi([e], t)
        ...
        isLoadingFuncs: [function (e) {
            ...
            dateProfile: function (e, t) {
                t.emitter.trigger("datesSet", r(r({}, Cr(e.activeRange, t.dateEnv)), {view: t.viewApi}))
    ...
    var ji = function () {
        function e(e) {
            ...
            var s, l, u,
                c = (s = o.calendarOptions, l = o.dateEnv, null != (u = s.initialDate) ? l.createMarker(u) : Ur(s.now, l)),
        ...
        return e.prototype.resetOptions = function (e, t) {
            ...
            var e, t, n, o, i, a, s, l, u, c = this.props, d = this.state, p = this.data,
                ...
                y = f.calendarOptions;
            if (m && m !== y) for (var E in m.timeZone !== y.timeZone && (d.eventSources = v.eventSources = (a = v.eventSources, s = d.dateProfile, l = v, u = s ? s.activeRange : null, Di(a, xi(a, l), u, !0, l)), d.eventStore = v.eventStore = (e = v.eventStore, t = p.dateEnv, n = v.dateEnv, o = e.defs, i = Nt(e.instances, (function (e) {
                var i = o[e.defId];
            ...
            var n = _n([wn, e, t]), o = n.locales, i = n.locale, a = this.organizeRawLocales(o), s = a.map,
                l = this.buildLocale(i || a.defaultCode, s).options, u = this.buildPluginHooks(e.plugins || [], Vi),
                c = this.currentCalendarOptionsRefiners = r(r(r(r(r({}, Sn), Dn), Tn), u.listenerRefiners), u.optionRefiners),
                d = {}, p = _n([wn, l, e, t]), f = {}, h = this.currentCalendarOptionsInput,
            ...
            var a = _n([wn, e.optionDefaults, n, o, e.optionOverrides, i]),
                s = r(r(r(r(r(r({}, Sn), Dn), Tn), kn), t.listenerRefiners), t.optionRefiners), l = {},
    ...
    var na = function (e) {
        ...
        return e.prototype.addSegs = function (e) {
            ...
            -1 === t.lateral ? (ua(r, t.level, t.levelCoord), ua(n, t.level, [e])) : ua(n[t.level], t.lateral, e), this.stackCnts[ia(e)] = t.stackCnt
            ...
            for (var t = this, n = t.levelCoords, r = t.entriesByLevel, o = t.strictOrder, i = t.stackCnts, a = n.length, s = 0, l = -1, u = -1, c = null, d = 0, p = 0; p < a; p += 1) {
                ...
                for (var h = r[p], v = void 0, g = ca(h, e.span.start, oa), m = g[0] + g[1]; (v = h[m]) && v.span.start < e.span.end;) {
                    var y = f + v.thickness;
    ...
    function aa(e) {
        for (var t = [], n = 0, r = e; n < r.length; n++) {
            for (var o = r[n], i = [], a = {span: o.span, entries: [o]}, s = 0, l = t; s < l.length; s++) {
                var u = l[s];
                la(u.span, a.span) ? a = {entries: u.entries.concat(a.entries), span: sa(u.span, a.span)} : i.push(u)
            }
            i.push(a), t = i
        }
        return t
    ...
    }(), va = {}, ga = {startTime: Gt, duration: Gt, create: Boolean, sourceId: String};

    function ma(e) {
        var t = Rn(e, ga), n = t.refined, r = t.extra;
        return {
    ...
    var ya = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo.apply(void 0, o(["div", {className: "fc-toolbar-chunk"}], t))
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return a.left ? (i = !0, e = a.left) : e = a.start, a.right ? (i = !0, t = a.right) : t = a.end, Lo("div", {className: [o || "", "fc-toolbar", i ? "fc-toolbar-ltr" : ""].join(" ")}, this.renderSection("start", e || []), this.renderSection("center", s || []), this.renderSection("end", t || []))
        ...
        function t(t) {
            ...
            return n.handleSegClick = function (e, t) {
                var r = n.component, o = r.context, i = cr(t);
                if (i && r.isValidSegDownEl(e.target)) {
                    var a = Pe(e.target, ".fc-event-forced-url"), s = a ? a.querySelector("a[href]").href : "";
        ...
        return n(t, e), t.prototype.destroy = function () {
            ...
            var r = this.component, o = r.context, i = cr(n);
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildViewContext = on(Yo), t.buildViewPropTransformers = on(xa), t.buildToolbarProps = on(Ta), t.headerRef = Wo(), t.footerRef = Wo(), t.interactionsStore = {}, t.state = {viewLabelId: ze()}, t.registerInteractiveComponent = function (e, n) {
                var r = function (e, t) {
                    return {
                        component: e,
                        el: t.el,
                ...
                }(e, n), o = [Sa, wa].concat(t.props.pluginHooks.componentInteractions).map((function (e) {
                    return new e(r)
                }));
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(qo.Provider, {value: l}, n.header && Lo(Ea, r({
                ref: this.headerRef,
    ...
    function ka(e, t) {
        return bn(!e || t > 10 ? {weekday: "short"} : t > 1 ? {
            weekday: "short",
            month: "numeric",
            day: "numeric",
            omitCommas: !0
    ...
    var Ma = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.context, t = e.dateEnv, n = e.options, o = e.theme, i = e.viewApi, a = this.props, s = a.date,
                l = a.dateProfile, u = vo(s, a.todayRange, null, l), c = [_a].concat(go(u, o)),
                d = t.format(s, a.dayHeaderFormat), p = !u.isDisabled && a.colCnt > 1 ? Eo(this.context, s) : {},
            ...
            return Lo(oi, {
                ...
                return Lo("th", r({
                    ...
                    colSpan: a.colSpan
                }, a.extraDataAttrs), Lo("div", {className: "fc-scrollgrid-sync-inner"}, !u.isDisabled && Lo("a", r({
                    ref: n,
                    className: ["fc-col-header-cell-cushion", a.isSticky ? "fc-sticky" : ""].join(" ")
                }, p), o)))
            }))
        }, t
    }(Xo), Ia = bn({weekday: "long"}), Pa = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.dateEnv, o = t.theme, i = t.viewApi, a = t.options,
                ...
                u = [_a].concat(go(l, o), e.extraClassNames || []), c = n.format(s, e.dayHeaderFormat),
            ...
            return Lo(oi, {
                ...
                return Lo("th", r({
                    ...
                    colSpan: e.colSpan
                }, e.extraDataAttrs), Lo("div", {className: "fc-scrollgrid-sync-inner"}, Lo("a", {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var e = this.props, t = this.context,
                ...
                r = t.dateEnv.startOf(n, e.unit), o = t.dateEnv.add(r, Gt(1, e.unit)), i = o.valueOf() - n.valueOf();
    ...
    var Aa = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(Na, {unit: "day"}, (function (e, t) {
                return Lo("tr", {role: "row"}, i && i("day"), n.map((function (e) {
                    return o ? Lo(Ma, {
                        key: e.toISOString(),
                        date: e,
                        dateProfile: r,
                        ...
                        colCnt: n.length,
                        dayHeaderFormat: a
                    }) : Lo(Pa, {key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: a})
                })))
            }))
        }, t
    }(Xo);
    ...
    var La = function () {
        ...
        return e.prototype.sliceRange = function (e) {
            var t = this.getDateDayIndex(e.start), n = this.getDateDayIndex(ft(e.end, -1)), r = Math.max(0, t),
            ...
            var t = this.indices, n = Math.floor(gt(this.dates[0], e));
        ...
        return e.prototype.sliceProps = function (e, t, n, r) {
            ...
            return this._sliceDateSpan.apply(this, o([{range: {start: e, end: ht(e, 1)}, allDay: !1}, {}, t], n))
            ...
            for (var a = function (e, t, n) {
                var r = Yn({editable: !1}, n), o = Xn(r.refined, r.extra, "", e.allDay, !0, n);
                return {def: o, ui: pr(o, t), instance: Rt(o.defId, e.range), range: e.range, isStart: !0, isEnd: !0}
            ...
            var n = e.range;
            this.forceDayIfListItem && "list-item" === e.ui.display && (n = {start: n.start, end: ft(n.start, 1)});
    ...
    function ja(e, t, n, o) {
        return void 0 === n && (n = {}), !(e.eventDrag && !function (e, t, n, o) {
            ...
            }), p = d.defs, f = d.instances, h = dr(p, e.eventUiBases);
            var v, g;
            for (var m in u) {
                ...
                for (var C = i.eventStore, k = 0, _ = b.allows; k < _.length; k++) {
                    var R = _[k], M = r(r({}, n), {range: y.range, allDay: S.allDay}), I = C.defs[S.defId],
    ...
    var Xa = /^(visible|hidden)$/, Ka = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
    ...
    function ts(e, t, n, r) {
        ...
        }, n.tableColGroupNode, Lo(r ? "thead" : "tbody", {role: "presentation"}, "function" == typeof t.rowContent ? t.rowContent(n) : t.rowContent))
    }
    ...
    function rs(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++) for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1) n.push(Lo("col", {
            style: {
    ...
    var ds = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = e.props, n = e.state, r = e.context, i = t.sections || [], a = this.processCols(t.cols),
                s = this.renderMicroColGroup(a, n.shrinkWidth), l = as(t.liquid, r);
            ...
            return "outerContent" in e ? Lo(Vo, {key: e.key}, e.outerContent) : Lo("tr", {
                key: e.key,
                role: "presentation",
            ...
            var o = this.props, i = this.state, a = i.forceYScrollbars, s = i.scrollerClientWidths,
                l = i.scrollerClientHeights, u = es(o, e), c = Qa(o, e),
                d = o.liquid ? a ? "scroll" : u ? "auto" : "hidden" : "visible", p = e.key, f = ts(e, n, {
                    tableColGroupNode: t,
                    tableMinWidth: "",
            ...
            return Lo(r ? "th" : "td", {
                ref: n.elRef,
                role: "presentation"
            }, Lo("div", {className: "fc-scroller-harness" + (c ? " fc-scroller-harness-liquid" : "")}, Lo(Ka, {
            ...
            var e = Do(), t = this.scrollerRefs, n = this.scrollerElRefs, r = !1, o = {}, i = {};
    ...
    var ps = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(ps, {
                ...
                }, s), l.isStartResizable && Lo("div", {className: "fc-event-resizer fc-event-resizer-start"}), l.isEndResizable && Lo("div", {className: "fc-event-resizer fc-event-resizer-end"}))
            }))
        }, t
    }(Xo);

    function hs(e) {
        return Lo("div", {className: "fc-event-main-frame"}, e.timeText && Lo("div", {className: "fc-event-time"}, e.timeText), Lo("div", {className: "fc-event-title-container"}, Lo("div", {className: "fc-event-title fc-sticky"}, e.event.title || Lo(Vo, null, "Â "))))
    }
    ...
    }, gs = bn({day: "numeric"}), ms = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }

        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options, r = ys({
                date: e.date,
                dateProfile: e.dateProfile,
            ...
            return Lo(ai, {hookProps: r, content: n.dayCellContent, defaultContent: e.defaultContent}, e.children)
        }, t
    }(Xo);

    function ys(e) {
        var t = e.date, n = e.dateEnv, o = vo(t, e.todayRange, null, e.dateProfile);
        return r(r(r({
            date: n.toDate(t),
            view: e.viewApi
        }, o), {dayNumberText: e.showDayNumber ? n.format(t, gs) : ""}), e.extraProps)
    }
    ...
    function ws(e) {
        return e.event.title && Lo("div", {className: "fc-event-title"}, e.event.title)
    }
    ...
    var xs = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.state = {titleId: ze()}, t.handleRootEl = function (e) {
                t.rootEl = e, t.props.elRef && Jo(t.props.elRef, e)
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, o.extraAttrs, {ref: this.handleRootEl}), Lo("div", {className: "fc-popover-header " + t.getClass("popoverHeader")}, Lo("span", {
            ...
            })), Lo("div", {className: "fc-popover-body " + t.getClass("popoverContent")}, o.children)), o.parentEl)
        }, t.prototype.componentDidMount = function () {
            ...
            if (i) {
                var a = o.getBoundingClientRect(), s = r ? Pe(n, ".fc-scrollgrid").getBoundingClientRect().top : i.top,
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(Es, {date: o, dateProfile: a, todayRange: i, elRef: this.handleRootEl}, (function (e, t, n) {
                return Lo(xs, {
                    elRef: e,
                    id: r.id,
                    title: s,
                    ...
                    onClose: r.onClose
                }, Lo(ms, {date: o, dateProfile: a, todayRange: i}, (function (e, t) {
                    return t && Lo("div", {className: "fc-more-popover-misc", ref: e}, t)
                })), r.children)
            }))
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.linkElRef = Wo(), t.state = {isPopoverOpen: !1, popoverId: ze()}, t.handleClick = function (e) {
                var n = t, r = n.props, o = n.context, i = o.options.moreLinkClick, a = Rs(r).start;
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(qo.Consumer, null, (function (r) {
                var o = r.viewApi, i = r.options, a = r.calendarApi, s = i.moreLinkText, l = t.moreCnt, u = Rs(t),
                    c = "function" == typeof s ? s.call(a, l) : "+" + l + " " + s, d = st(i.moreLinkHint, [l], c),
                ...
                if (o.isRendering) {
                    ...
                    Bo((function () {
                        Uo(Lo(Ca, {
                            ...
                            return o.setClassNames(t), o.setHeight(n), Lo(ii.Provider, {value: o.customContentRenderId}, Lo(Da, r({
                                isHeightAuto: i,
                                forPrint: a
                            }, e)))
                        })), o.el)
    ...
    var Hs = 0, As = 0, Os = !1, Ls = function () {
        function e(e) {
            var t = this;
            ...
            }, this.containerEl = e, this.emitter = new Mo, e.addEventListener("mousedown", this.handleMouseDown), e.addEventListener("touchstart", this.handleTouchStart, {passive: !0}), 1 === (As += 1) && window.addEventListener("touchmove", Us, {passive: !1})
        }

        return e.prototype.destroy = function () {
            this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {passive: !0}), (As -= 1) || window.removeEventListener("touchmove", Us, {passive: !1})
    ...
    }(Vs), Bs = "function" == typeof performance ? performance.now : Date.now, js = function () {
        function e() {
            var e = this;
        ...
        function t(t) {
            ...
            n.handlePointerDown = function (e) {
                ...
                if (!n.dragging.pointer.wasTouchScroll) {
                    ...
                    if (i && a && Zs(i, a)) {
                        var s = t.context, l = r(r({}, Xs(i.dateSpan, s)), {
                            dayEl: i.dayEl,
                            jsEvent: e.origEvent,
        ...
        function t(t) {
            ...
            n.dragSelection = null, n.handlePointerDown = function (e) {
                ...
                i ? o.dispatch({
                    type: "SELECT_DATES",
                    selection: i
                }) : t || o.dispatch({type: "UNSELECT_DATES"}), a ? Ke() : $e(), t || (n.dragSelection = i)
            }, n.handlePointerUp = function (e) {
                n.dragSelection && (_r(n.dragSelection, e, n.component.context), n.dragSelection = null)
            };
            var o = t.component.context.options, i = n.dragging = new Gs(t.el);
    ...
    var Js = function (e) {
        function t(n) {
            ...
            o.subjectEl = null, o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingContext = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function (e) {
                ...
                var u = o.subjectSeg = cr(e.subjectEl), c = (o.eventRange = u.eventRange).instance.instanceId;
                ...
                if (o.isDragging) {
                    var t = o.component.context, n = t.viewApi, i = o, a = i.receivingContext, s = i.validMutation,
                        l = o.eventRange.def, u = o.eventRange.instance, c = new Vr(t, l, u), d = o.relevantEvents,
                    ...
                    if (o.clearDrag(), t.emitter.trigger("eventDragStop", {
                        ...
                        if (a === t) {
                            ...
                            for (var v = {
                                oldEvent: c, event: h, relatedEvents: Fr(p, t, u), revert: function () {
                            ...
                            var b = {
                                event: c, relatedEvents: Fr(d, t, u), revert: function () {
                                    t.dispatch({type: "MERGE_EVENTS", eventStore: d})
                                }
                            };
                            ...
                            var S = p.defs[l.defId], w = p.instances[u.instanceId], D = new Vr(a, S, w);
                            a.dispatch({type: "MERGE_EVENTS", eventStore: p});
                            var T = {
                                event: D, relatedEvents: Fr(p, a, w), revert: function () {
            ...
            var i = o.component.context.options, a = o.dragging = new Gs(n.el);
    ...
    var Qs = function (e) {
        function t(t) {
            ...
            n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function (e) {
                var t = n.component, r = cr(n.querySegEl(e)), o = n.eventRange = r.eventRange;
                ...
                l && (u = Ir(i, o.getCurrentData().eventUiBases, l, o), d.mutatedEvents = u, za(d, e.dateProfile, o) || (c = !0, l = null, u = null, d.mutatedEvents = null)), u ? o.dispatch({
                    ...
                    state: d
                }) : o.dispatch({type: "UNSET_EVENT_RESIZE"}), c ? Ke() : $e(), t || (l && Zs(a, e) && (l = null), n.validMutation = l, n.mutatedRelevantEvents = u)
            }, n.handleDragEnd = function (e) {
                var t = n.component.context, o = n.eventRange.def, i = n.eventRange.instance, a = new Vr(t, o, i),
                ...
                if (t.emitter.trigger("eventResizeStop", {
                    ...
                    var c = {
                        oldEvent: a, event: u, relatedEvents: Fr(l, t, i), revert: function () {
            ...
            var o = t.component, i = n.dragging = new Gs(t.el);
    ...
    var el = function () {
        function e(e) {
            ...
            this.context = e, this.isRecentPointerDateSelect = !1, this.matchesCancel = !1, this.matchesEvent = !1, this.onSelect = function (e) {
                ...
                var n = t.context.options.unselectCancel, r = Ue(e.origEvent);
        ...
        function e(e, t) {
            ...
            this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
                ...
                e && (a = e.context, n.canDropElOnCalendar(o.subjectEl, a) && (s = function (e, t, n) {
                    ...
                    var l = Yn(o, n), u = l.refined, c = l.extra,
        ...
        return e.prototype.buildDragMeta = function (e) {
            return "object" == typeof this.suppliedDragMeta ? ma(this.suppliedDragMeta) : "function" == typeof this.suppliedDragMeta ? ma(this.suppliedDragMeta(e)) : (t = function (e, t) {
                var n = va.dataAttrPrefix, r = (n ? n + "-" : "") + t;
                return e.getAttribute("data-" + r) || ""
            }(e, "event"), ma(t ? JSON.parse(t) : {create: !1}));
            var t
    ...
    var ol = function () {
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t) {
            var n = this.props, r = this.context, o = [], i = us(r.options);
            return e && o.push({
                type: "header",
                key: "header",
                isSticky: i,
            ...
            var i = this.props, a = this.context, s = !i.forPrint && us(a.options), l = !i.forPrint && cs(a.options),
                u = [];
            return e && u.push({
                type: "header",
                key: "header",
    ...
    var pl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = Eo(this.context, e.date);
            return Lo(ms, {
                date: e.date,
                dateProfile: e.dateProfile,
                todayRange: e.todayRange,
                ...
                return (o || e.forceDayTop) && Lo("div", {
                    ...
                    ref: n
                }, Lo("a", r({id: e.dayNumberId, className: "fc-daygrid-day-number"}, t), o || Lo(Vo, null, "Â ")))
            }))
        }, t
    }(Xo);
    ...
    var hl = bn({hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "narrow"});
    ...
    var gl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options.eventTimeFormat || hl,
    ...
    function yl(e) {
        ...
        }), e.timeText && Lo("div", {className: "fc-event-time"}, e.timeText), Lo("div", {className: "fc-event-title"}, e.event.title || Lo(Vo, null, "Â ")))
    }
    ...
    var Sl = bn({week: "narrow"}), wl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.rootElRef = Wo(), t.state = {dayNumberId: ze()}, t.handleRootEl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(Es, {
                ...
                }, u, n.extraDataAttrs, n.showDayNumber ? {"aria-labelledby": o.dayNumberId} : {}), Lo("div", {
                    className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner",
                    ref: n.innerElRef
                }, n.showWeekNumber && Lo(Ds, {date: a, defaultFormat: Sl}, (function (e, t, n, o) {
                    return Lo("a", r({ref: e, className: ["fc-daygrid-week-number"].concat(t).join(" ")}, l), o)
                })), !c && Lo(pl, {
                    date: a,
                    dateProfile: s,
                    showDayNumber: n.showDayNumber,
    ...
    function Tl(e, t, n, o) {
        ...
        var i = e.eventRange, a = i.range, s = nr(a, {start: o[t].date, end: ft(o[n - 1].date, 1)});
        return r(r({}, e), {
            firstCol: t,
            lastCol: n - 1,
    ...
    var xl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this, n = t.props, r = t.state, o = t.context.options, i = n.cells.length,
                a = cl(n.businessHourSegs, i), s = cl(n.bgEventSegs, i), l = cl(this.getHighlightSegs(), i),
            ...
            if (c) for (var h = 0, v = t; h < v.length; h++) {
                var g = v[h], m = g.seg, y = m.eventRange.instance.instanceId, E = y + ":" + e,
                    b = g.isVisible && !o[y], S = g.isAbsolute, w = "", D = "";
    ...
    var kl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return f && !i && (f = !1, r = null, o = null), Lo("div", {
                ...
                }, t.colGroupNode, Lo("tbody", {role: "presentation"}, t.cells.map((function (i, f) {
                    return Lo(Cl, {
    ...
    var Rl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context;
            return Lo(kl, r({ref: this.tableRef}, this.slicer.sliceProps(e, e.dateProfile, e.nextDayThreshold, t, e.dayTableModel), {
                dateProfile: e.dateProfile,
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.context, n = t.options, r = t.dateProfileGenerator, o = this.props,
                i = this.buildDayTableModel(o.dateProfile, r), a = n.dayHeaders && Lo(Aa, {
                    ref: this.headerRef,
    ...
    }(fo), Ol = bn({hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "short"});

    function Ll(e) {
        var t = ["fc-timegrid-slot", "fc-timegrid-slot-label", e.isLabeled ? "fc-scrollgrid-shrink" : "fc-timegrid-slot-minor"];
        return Lo(qo.Consumer, null, (function (n) {
            if (!e.isLabeled) return Lo("td", {className: t.join(" "), "data-time": e.isoTimeStr});
            ...
            return Lo(oi, {
                ...
                }, Lo("div", {className: "fc-timegrid-slot-label-frame fc-scrollgrid-shrink-frame"}, Lo("div", {
    ...
    var Wl = function (e) {
    ...
    }(Xo), Vl = bn({week: "short"}), zl = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.allDaySplitter = new Al, t.headerElRef = Wo(), t.rootElRef = Wo(), t.scrollerElRef = Wo(), t.state = {slatCoords: null}, t.handleScrollTopRequest = function (e) {
                ...
                }, Lo("div", {className: "fc-timegrid-axis-frame", style: {height: n}}))
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t, n) {
            var r = this.context, o = this.props, i = [], a = us(r.options);
            return e && i.push({
                type: "header",
                key: "header",
                isSticky: a,
                ...
                }, Lo("td", {className: "fc-timegrid-divider " + r.theme.getClass("tableCellShaded")}))
            })), i.push({
                type: "body",
                key: "body",
                liquid: !0,
            ...
            }), Lo(pi, {viewSpec: r.viewSpec, elRef: this.rootElRef}, (function (e, t) {
                return Lo("div", {
            ...
            var u = this.context, c = this.props, d = !c.forPrint && us(u.options), p = !c.forPrint && cs(u.options),
                f = [];
            e && f.push({
                type: "header",
                key: "header",
                ...
                chunks: [{
                    key: "axis", rowContent: function (e) {
                        return Lo("tr", {role: "presentation"}, s.renderHeadAxis("day", e.rowSyncHeights[0]))
                    }
                ...
                chunks: [{
                    key: "axis", rowContent: function (e) {
                        return Lo("tr", {role: "presentation"}, s.renderTableRowAxis(e.rowSyncHeights[0]))
                    }
                }, {key: "cols", content: t}]
            }), f.push({
                key: "all-day-divider",
                type: "body",
                outerContent: Lo("tr", {role: "presentation", className: "fc-scrollgrid-section"}, Lo("td", {
                    colSpan: 2,
            ...
            return f.push({
                ...
                chunks: [{
                    key: "axis", content: function (e) {
                        return Lo("div", {className: "fc-timegrid-axis-chunk"}, Lo("table", {
                            "aria-hidden": !0,
                            style: {height: e.expandRows ? e.clientHeight : ""}
                        }, e.tableColGroupNode, Lo("tbody", null, Lo(Wl, {slatMetas: i}))), Lo("div", {className: "fc-timegrid-now-indicator-container"}, Lo(Na, {unit: h ? "minute" : "day"}, (function (e) {
                            var t = h && a && a.safeComputeTop(e);
                            return "number" == typeof t ? Lo(vs, {isAxis: !0, date: e}, (function (e, n, r, o) {
                                return Lo("div", {
                                    ref: e,
                ...
                type: "footer",
                isSticky: !0,
                chunks: [{key: "axis", content: ls}, {key: "cols", content: ls}]
            }), Lo(pi, {viewSpec: u.viewSpec, elRef: this.rootElRef}, (function (e, t) {
                return Lo("div", {
                    className: ["fc-timegrid"].concat(t).join(" "),
                    ref: e
                }, Lo(l, {
    ...
    var Bl = function () {
        ...
        return e.prototype.safeComputeTop = function (e) {
            ...
            if (ar(t.currentRange, e)) {
                var n = bt(e), r = e.valueOf() - n.valueOf();
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo("tbody", null, e.slatMetas.map((function (i, a) {
                ...
                return Lo("tr", {key: i.key, ref: o.createRef(i.key)}, e.axis && Lo(Ll, r({}, i)), Lo(oi, {
                    hookProps: s,
                    ...
                    return Lo("td", {ref: e, className: l.concat(t).join(" "), "data-time": i.isoTimeStr}, r)
                })))
            })))
        }, t
    }(Xo), Gl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context;
            return Lo("div", {ref: this.rootElRef, className: "fc-timegrid-slots"}, Lo("table", {
                "aria-hidden": !0,
                className: t.theme.getClass("table"),
                style: {minWidth: e.tableMinWidth, width: e.clientWidth, height: e.minHeight}
            }, e.tableColGroupNode, Lo(jl, {slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas})))
        }, t.prototype.componentDidMount = function () {
            this.updateSizing()
        }, t.prototype.componentDidUpdate = function () {
            this.updateSizing()
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(ks, {
                ...
                return Lo("a", {
                    ...
                    "aria-expanded": l,
                    "aria-controls": u
                }, Lo("div", {ref: o, className: "fc-timegrid-more-link-inner fc-sticky"}, i))
            }))
        }, t
    }(Xo);
    ...
    function Kl(e, t, n) {
        ...
        var i, a, s, l = aa(o.addSegs(e)), u = function (e) {
            var t = e.entriesByLevel, n = eu((function (e, t) {
                return e + ":" + t
            }), (function (o, i) {
                var a = function (e, t, n) {
                    for (var r = e.levelCoords, o = e.entriesByLevel, i = o[t][n], a = r[t] + i.thickness, s = r.length, l = t; l < s && r[l] < a; l += 1) ;
                    for (; l < s; l += 1) {
                        for (var u = o[l], c = void 0, d = ca(u, i.span.start, oa), p = d[0] + d[1], f = p; (c = u[f]) && c.span.start < i.span.end;) f += 1;
                        if (p < f) return {level: l, lateralStart: p, lateralEnd: f}
                    }
                    return null
                }(e, o, i), s = $l(a, n), l = t[o][i];
                return [r(r({}, l), {nextLevelNodes: s[0]}), l.thickness + s[1]]
            }));
            return $l(t.length ? {level: 0, lateralStart: 0, lateralEnd: t[0].length} : null, n)[0]
        }(o);
    ...
    var nu = bn({hour: "numeric", minute: "2-digit", meridiem: !1}), ru = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(ms, {
                ...
                return t && Lo("div", {className: "fc-timegrid-col-misc", ref: e}, t)
            }))
        }, t
    }(Xo), iu = function (e) {
        function t() {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(Es, {
                ...
                }, u, t.extraDataAttrs), Lo("div", {className: "fc-timegrid-col-frame"}, Lo("div", {className: "fc-timegrid-col-bg"}, e.renderFillSegs(t.businessHourSegs, "non-business"), e.renderFillSegs(t.bgEventSegs, "bg-event"), e.renderFillSegs(t.dateSelectionSegs, "highlight")), Lo("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(s, a, !1, !1, !1)), Lo("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(i, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(o))), Lo("div", {className: "fc-timegrid-now-indicator-container"}, e.renderNowIndicator(t.nowIndicatorSegs)), Lo(ou, {
                    date: t.date,
                    dateProfile: t.dateProfile,
                    todayRange: t.todayRange,
                    extraHookProps: t.extraHookProps
            ...
            var a = this, s = this.context.options, l = s.eventMaxStack, u = s.eventShortHeight, c = s.eventOrderStrict,
                ...
                }(e, tu(e, f, h, d), c, l), b = E.segPlacements, S = E.hiddenGroups;
            return Lo(Vo, null, this.renderHiddenGroups(S, e), b.map((function (e) {
                var s = e.seg, l = e.rect, c = s.eventRange.instance.instanceId, d = y || Boolean(!t[c] && l),
                    p = su(l && l.span), f = !y && l ? a.computeSegHStyle(l) : {left: 0, right: 0},
            ...
            return Lo(Vo, null, e.map((function (e) {
                var n, c, d = su(e.span), p = (n = e.entries, c = t, n.map((function (e) {
                    return c[e.index]
                })));
                return Lo(Zl, {
                    key: Qt(Ms(p)),
            ...
            var n = this.props, o = this.context,
                i = tu(e, n.date, n.slatCoords, o.options.eventMinHeight).map((function (o, i) {
                    ...
                    return Lo("div", {
                        ...
                        style: su(o)
                    }, "bg-event" === t ? Lo(Ss, r({seg: a}, Er(a, n.todayRange, n.nowDate))) : bs(t))
                }));
            return Lo(Vo, null, i)
        }, t.prototype.renderNowIndicator = function (e) {
            var t = this.props, n = t.slatCoords, r = t.date;
            return n ? e.map((function (e, t) {
                return Lo(vs, {isAxis: !1, date: r, key: t}, (function (t, o, i, a) {
                    return Lo("div", {
                        ref: t,
    ...
    function au(e, t) {
        ...
        return Lo(Vo, null, e.map((function (e) {
            ...
            return Lo("div", {key: t, style: {visibility: l[t] ? "hidden" : ""}}, Lo(ru, r({
                seg: e,
                isDragging: !1,
                isResizing: !1,
                isDateSelecting: !1,
    ...
    var lu = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo("div", {className: "fc-timegrid-cols", ref: this.rootElRef}, Lo("table", {
                role: "presentation",
                style: {minWidth: t.tableMinWidth, width: t.clientWidth}
            }, t.tableColGroupNode, Lo("tbody", {role: "presentation"}, Lo("tr", {role: "row"}, t.axis && Lo("td", {
                "aria-hidden": !0,
                className: "fc-timegrid-col fc-timegrid-axis"
            }, Lo("div", {className: "fc-timegrid-col-frame"}, Lo("div", {className: "fc-timegrid-now-indicator-container"}, "number" == typeof n && Lo(vs, {
                isAxis: !0,
                date: t.nowDate
            }, (function (e, t, r, o) {
                return Lo("div", {
    ...
    var uu = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.processSlotOptions = on(cu), t.state = {slatCoords: null}, t.handleRootEl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            if (null != p && null != f) {
                var h = this.props.cells[p], v = l.positions.tops[f], g = l.positions.getHeight(f), m = (t - v) / g,
                    y = f * d + Math.floor(m * d), E = this.props.cells[p].date, b = Yt(s.slotMinTime, Zt(c, y)),
                    S = o.add(E, b), w = o.add(S, c);
                return {
                    dateProfile: s,
                    dateSpan: r({range: {start: S, end: w}, allDay: !1}, h.extraDateSpan),
                    dayEl: a.els[p],
    ...
    var du = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(Na, {unit: a ? "minute" : "day"}, (function (l, u) {
                return Lo(uu, r({ref: e.timeColsRef}, e.slicer.sliceProps(t, o, null, n, s), {
                    forPrint: t.forPrint,
                    axis: t.axis,
                    dateProfile: o,
    ...
    var hu = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}];

    function vu(e, t, n, r, o) {
        for (var i = new Date(0), a = e, s = Gt(0), l = n || function (e) {
            var t, n, r;
            for (t = hu.length - 1; t >= 0; t -= 1) if (null !== (r = $t(n = Gt(hu[t]), e)) && r > 1) return n;
            return e
        }(r), u = []; Kt(a) < Kt(t);) {
            var c = o.add(i, a), d = null !== $t(s, l);
            u.push({
                date: c,
                time: a,
                key: c.toISOString(),
    ...
    var gu = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.context, n = t.options, o = t.dateEnv, i = t.dateProfileGenerator, a = this.props,
                ...
                d = n.dayMinWidth, p = !d, f = d, h = n.dayHeaders && Lo(Aa, {
                    dates: l.headerDates,
                    dateProfile: s,
    ...
    var yu = ei({
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.context, t = e.theme, n = e.dateEnv, o = e.options, i = e.viewApi, a = this.props,
                s = a.cellId, l = a.dayDate, u = a.todayRange, c = this.state.textId, d = vo(l, u),
            ...
            return Lo(oi, {
                ...
                return Lo("tr", {
                    ...
                    id: s,
                    "aria-labelledby": c
                }, Lo("div", {className: "fc-list-day-cushion " + t.getClass("tableCellShaded"), ref: r}, o)))
            }))
        }, t
    }(Xo);
    ...
    var Su = bn({hour: "numeric", minute: "2-digit", meridiem: "short"}), wu = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = e.seg, o = e.timeHeaderId, i = e.eventHeaderId,
                a = e.dateHeaderId, s = t.options.eventTimeFormat || Su;
            return Lo(ps, {
                seg: n,
                timeText: "",
                disableDragging: !0,
                ...
                })), Lo("td", {ref: l, headers: i + " " + a, className: "fc-list-event-title"}, u))
            }))
        }, t
    }(Xo);
    ...
    var Tu = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Lo(pi, {viewSpec: n.viewSpec, elRef: this.setRootEl}, (function (n, o) {
                return Lo("div", {ref: n, className: r.concat(o).join(" ")}, Lo(Ka, {
            ...
            return Lo(Na, {unit: "day"}, (function (e, n) {
                for (var a = [], d = 0; d < c.length; d += 1) {
                    ...
                    if (p) {
                        var f = en(t[d]), h = u + "-" + f;
                        a.push(Lo(Eu, {key: f, cellId: h, dayDate: t[d], todayRange: n}));
                ...
                return Lo("table", {className: "fc-list-table " + o.getClass("table")}, Lo("thead", null, Lo("tr", null, Lo("th", {
                    scope: "col",
                    id: s
                }, i.timeHint), Lo("th", {scope: "col", "aria-hidden": !0}), Lo("th", {
                    scope: "col",
                    id: l
            ...
            var n, r, o, i = this.context.dateEnv, a = this.context.options.nextDayThreshold, s = e.range,
                l = e.def.allDay, u = [];
            for (n = 0; n < t.length; n += 1) if ((r = nr(s, t[n])) && (o = {
                component: this,
                eventRange: e,
                start: r.start,
                end: r.end,
    ...
    var Mu = ei({themeClasses: {bootstrap: Ru}}), Iu = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
    ...
    var Pu = ei({themeClasses: {bootstrap5: Iu}}), Nu = "https://www.googleapis.com/calendar/v3/calendars";
    var Hu = ei({
        eventSourceDefs: [{
            parseMeta: function (e) {
    ...
    return Vi.push(sl, Hl, yu, _u, Mu, Pu, Hu), e.BASE_OPTION_DEFAULTS = wn, e.BASE_OPTION_REFINERS = Sn, e.BaseComponent = Xo, e.BgEvent = Ss, e.BootstrapTheme = Ru, e.Calendar = Ns, e.CalendarApi = Wr, e.CalendarContent = Da, e.CalendarDataManager = ji, e.CalendarDataProvider = ta, e.CalendarRoot = Ca, e.Component = Oo, e.ContentHook = ai, e.CustomContentRenderContext = ii, e.DateComponent = Qo, e.DateEnv = Zr, e.DateProfileGenerator = mi, e.DayCellContent = ms, e.DayCellRoot = Es, e.DayGridView = Il, e.DayHeader = Aa, e.DaySeriesModel = La, e.DayTable = Ml, e.DayTableModel = Ua, e.DayTableSlicer = Rl, e.DayTimeCols = pu, e.DayTimeColsSlicer = du, e.DayTimeColsView = gu, e.DelayedRunner = zi, e.Draggable = ol, e.ElementDragging = ha, e.ElementScrollController = No, e.Emitter = Mo, e.EventApi = Vr, e.EventRoot = ps, e.EventSourceApi = Me, e.FeaturefulElementDragging = Gs, e.Fragment = Vo, e.Interaction = da, e.ListView = Tu, e.MoreLinkRoot = ks, e.MountHook = li, e.NamedTimeZoneImpl = na, e.NowIndicatorRoot = vs, e.NowTimer = Na, e.PointerDragging = Ls, e.PositionCache = Io, e.RefMap = $a, e.RenderHook = oi, e.ScrollController = Po, e.ScrollResponder = Go, e.Scroller = Ka, e.SegHierarchy = ra, e.SimpleScrollGrid = ds, e.Slicer = Wa, e.Splitter = fo, e.StandardEvent = fs, e.Table = kl, e.TableDateCell = Ma, e.TableDowCell = Pa, e.TableView = ll, e.Theme = Ao, e.ThirdPartyDraggable = al, e.TimeCols = uu, e.TimeColsSlatsCoords = Bl, e.TimeColsView = zl, e.ViewApi = Hr, e.ViewContextType = qo, e.ViewRoot = pi, e.WeekNumberRoot = Ds, e.WindowScrollController = Ho, e.addDays = ft, e.addDurations = Yt, e.addMs = ht, e.addWeeks = pt, e.allowContextMenu = tt, e.allowSelection = Qe, e.applyMutationToEventStore = Ir, e.applyStyle = Oe, e.applyStyleProp = Le, e.asCleanDays = function (e) {
        ...
        void 0 === t && (t = {});
        var n = to(t), r = bn(t), o = n.createMarkerMeta(e);
        ...
        var r = to("object" == typeof n && n ? n : {}), o = bn(n), i = r.createMarkerMeta(e), a = r.createMarkerMeta(t);
        ...
        return function (a) {
            var s = {};
            for (var l in a) if (i[l]) if (rn(o[l], a[l])) s[l] = i[l]; else {
                n && n(i[l]);
                var u = e.apply(r, a[l]);
                s[l] = t && t(u, i[l]) ? i[l] : u
    ...
    },e.triggerDateSelect = _r,e.unmountComponentAtNode = jo,e.unpromisify = Ro,e.version = "5.11.5",e.whenTransitionDone = Ge,e.wholeDivideDurations = $t,Object.defineProperty(e, "__esModule", {value: !0}),e
}({});
[].push.apply(FullCalendar.globalLocales, function () {
    ...
    return [{
        ...
        code: "es",
        week: {dow: 0, doy: 6},
        buttonText: {prev: "Ant", next: "Sig", today: "Hoy", month: "Mes", week: "Semana", day: "DÃ­a", list: "Agenda"},
        weekText: "Sm",
        ...
        buttonHints: {prev: "Forrige $0", next: "Neste $0", today: "NÃ¥vÃ¦rende $0"},
        viewHint: "$0 visning",
        ...
        code: "ug",
        buttonText: {month: "Ø¦Ø§ÙŠ", week: "Ú¾Û•Ù¾ØªÛ•", day: "ÙƒÛˆÙ†", list: "ÙƒÛˆÙ†ØªÛ•Ø±ØªÙ‰Ù¾"},
